...
import com.example.pokemon.dto.CreatePokemonDto;
import com.example.pokemon.dto.PokemonResponseDto;
import com.example.pokemon.dto.UpdatePokemonDto;
...
public class PokemonController {
    ...
    @Operation(
            ...
            description = "Devuelve la lista de todos los Pokémon registrados"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
            ...
            description = "Devuelve un Pokémon específico mediante su ID"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Devuelve un Pokémon específico mediante su nombre, ignorando mayúsculas/minúsculas"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Crea un nuevo Pokémon con los datos proporcionados"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<PokemonResponseDto> createPokemon(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Datos del Pokémon a crear",
                    required = true,
                    content = @Content(
                            schema = @Schema(implementation = CreatePokemonDto.class)
                    )
            )
            @Valid @RequestBody CreatePokemonDto createDto) {
    ...
    @Operation(
            ...
            description = "Actualiza un Pokémon existente con los nuevos datos"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<PokemonResponseDto> updatePokemon(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Datos del Pokémon a actualizar",
                    required = true,
                    content = @Content(
                            schema = @Schema(implementation = UpdatePokemonDto.class)
                    )
            )
            @Valid @RequestBody UpdatePokemonDto updateDto) {

        PokemonResponseDto updated =
                pokemonService.updatePokemon(id, updateDto);
    ...
    @Operation(
            ...
            description = "Elimina un Pokémon existente por su ID"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
    ...
    @Operation(
            summary = "Eliminar Pokémon por nombre",
            description = "Elimina un Pokémon existente por su nombre, ignorando mayúsculas/minúsculas"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
    ...
    public ResponseEntity<Void> deletePokemonByName(
            @Parameter(
                    description = "Nombre del Pokémon a eliminar",
                    required = true,
                    example = "pikachu"
            )
            @PathVariable String name) {
