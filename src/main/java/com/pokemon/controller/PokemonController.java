...
=======
    ...
    public ResponseEntity<PokemonResponseDto> createPokemon(
        ...
        @DeleteMapping("/{id}")
        @Operation(summary = "Eliminar Pokémon por ID", description = "Elimina un Pokémon existente por su ID")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Eliminar Pokémon por nombre", description = "Elimina un Pokémon existente por su nombre, ignorando mayúsculas/minúsculas")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "204", description = "Pokémon eliminado exitosamente"),
                        @ApiResponse(responseCode = "404", description = "Pokémon no encontrado")
        })
        public ResponseEntity<Void> deletePokemonByName(
                        @Parameter(description = "Nombre del Pokémon a eliminar", required = true, example = "pikachu") @PathVariable String name) {
